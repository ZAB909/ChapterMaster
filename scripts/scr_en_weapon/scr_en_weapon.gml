function scr_en_weapon(name, is_man, man_number, man_type, group) {
	...
	if (obj_ncombat.enemy=6){
	    ...
	    if (name="Flamer"){atta=100;arp=0;rang=2;amm=4;spli=1;}
	...
	if (obj_ncombat.enemy=7){
	    ...
	    if (name="Slugga"){atta=27;arp=0;rang=3.1;amm=4;spli=1;}
	    if (name="Tankbusta Bomb"){atta=264;arp=1;rang=1;amm=2;spli=1;}
	    if (name="Big Shoota"){atta=100;arp=0;rang=12;amm=30;spli=0;}
	    if (name="Dakkagun"){atta=150;arp=0;rang=10;amm=20;spli=0;}
	    if (name="Deffgun"){atta=120;arp=0;rang=8;amm=20;spli=0;}
	    if (name="Snazzgun"){atta=80;arp=0;rang=10;spli=0;}
	    if (name="Grot Blasta"){atta=12;arp=0;rang=2;amm=6;}
	    if (name="Kannon"){atta=200;arp=1;rang=10.1;amm=5;spli=1;}
	    if (name="Shoota"){atta=30;arp=0;rang=6;}
	    if (name="Burna"){atta=140;arp=1;rang=2;amm=4;spli=1;}
	    if (name="Skorcha"){atta=160;arp=1;rang=2;amm=6;spli=1;}
	    if (name="Rokkit Launcha"){atta=150;arp=1;rang=15;spli=1;}
	...
	if (obj_ncombat.enemy=9){
	    ...
	    if (name="Autogun"){atta=20;arp=0;rang=6;amm=12;spli=1;}
	...
	if (obj_ncombat.enemy>=10) or (obj_ncombat.enemy=2) or (obj_ncombat.enemy=5) or (obj_ncombat.enemy=1){
	    ...
	    if (name="Meltagun"){atta=200;arp=1;rang=2;amm=4;}
	    if (name="Flamer"){atta=160;arp=0;rang=2.1;amm=4;spli=1;}
	    if (name="Heavy Flamer"){atta=250;arp=0;rang=2.1;amm=6;spli=1;}
	    if (name="Combi-Flamer"){atta=160;arp=0;rang=2.1;amm=1;spli=1;}
	    if (name="Bolter"){atta=45;arp=0;rang=12;amm=15;if (obj_ncombat.enemy=5) then atta=35;}// Bursts
	    if (name="Power Fist"){atta=425;arp=1;rang=1;}
	    if (name="Possessed Claws"){atta=250;arp=1;rang=1;spli=1;}
	    if (name="Missile Launcher"){atta=200;arp=1;rang=20;amm=4;spli=1;}
	    if (name="Chainsword"){atta=45;arp=0;rang=1;}
	    if (name="Bolt Pistol"){atta=35;arp=0;rang=3.1;amm=18;}
	    if (name="Chainaxe"){atta=55;arp=0;rang=1;}
	    ...
	    if (name="Autogun"){atta=20;arp=0;rang=6;amm=12;}
	    ...
	    if (name="Havoc Launcher"){atta=100;arp=0;rang=12;}
	    ...
	    if (name="Electro-Flail"){atta=125;arp=1;rang=1;spli=1;}
	    if (name="Neural Whip"){atta=85;arp=0;rang=1;spli=1}
  	  if (name="Sarissa"){atta=65;arp=0;rang=2;}
	    if (name="Seraphim Pistols"){atta=200;arp=1;rang=4;}
	    if (name="Laser Mace"){atta=200;arp=1;rang=5.1;amm=3;}
	    if (name="Heavy Bolter"){atta=120;arp=0;rang=16;spli=0;}
