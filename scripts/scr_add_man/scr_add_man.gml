	...
	if (good!=0){
	    ...
	    if (argument8=true){
	        if (argument0="Skitarii"){
	            ...
	            obj_ini.armor[argument1,good]="Skitarii Armour";obj_ini.experience[argument1,good]=10;
	        ...
	        if (argument0="Crusader"){
	            obj_ini.wep1[argument1,good]="Power Sword";obj_ini.armor[argument1,good]="Power Armour";
	        ...
	        if (argument0="Sister of Battle"){
	            ...
	            obj_ini.armor[argument1,good]="Power Armour";obj_ini.experience[argument1,good]=60;
	            obj_ini.hp[argument1,good]=40;obj_ini.race[argument1,good]=5;
	        }
	        if (argument0="Sister Hospitaler"){
	            obj_ini.wep1[argument1,good]="Bolter";obj_ini.wep2[argument1,good]="Sarissa";
	            obj_ini.armor[argument1,good]="Power Armour";obj_ini.experience[argument1,good]=100;
	        ...
	        if (argument0="Flash Git"){
	            ...
	            obj_ini.armor[argument1,good]="Ork Armour";obj_ini.experience[argument1,good]=40;
