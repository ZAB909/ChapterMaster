function scr_ui_advisors() {
	...
	if (menu=11){// Apothecarium
	    ...
	    if (training_apothecary>0) then blurp+="Our Brothers assigned to the training of future "+string(obj_ini.role[100,15])+"s have taken up a ";
	        ...
	        if (training_apothecary=5) then blurp+="frantic";
	    ...
	    if (menu_adept=1){
	        ...
	        if (training_apothecary=5) then blurp+=" is advancing franticly.";
	...
	if (menu=15){// Recruiting
	    ...
	    if (recruit_trial="Blood Duel"){blurp3="-10-30% More recruits#-2-4 Years shorter training time#-10% Chance to burn gene-seed";
	    ...
	    if (recruit_trial="Hunting the Hunter"){blurp3="-Planet Bonus': Desert, Ice, Death#-Up to 25 bonus XP on Neophytes";
	    ...
	    if (recruit_trial="Exposure"){blurp3="-Planet Bonus': Desert, Ice, Forge, Lava, Death#-1-3 Years shorter training time";
	    ...
	    if (recruit_trial="Challenge"){blurp3="-Standard generic choice #-Worthy proven Neophytes gain bonus 10-20 XP";
	    ...
	    if (recruit_trial="Apprenticeship"){blurp3="-Planet Bonus: Lava (+10-50% recruits)#-4-5 Years longer training time#-Almost enough experience to be promoted once complete";
