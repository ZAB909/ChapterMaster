function scr_ui_advisors() {
	...
	if (menu=15){// Recruiting
	    ...
	    if (recruit_trial="Survival of the Fittest"){blurp3="-Faster Neophyte Training#-Small chance of corruption";
	    ...
	    if (recruit_trial="Exposure"){blurp3="-Faster Neophyte Training#-Less Chance of Recruit Success";
	    ...
	    if (recruit_trial="Knowledge of Self"){blurp3="-Greatly Faster Neophyte Training#-Much Less Chance of Recruit Success";
	    ...
	    if (recruit_trial="Challenge"){blurp3="-Bonus Neophyte Experience#-Less Chance of Recruit Success";
	    ...
	    if (recruit_trial="Apprenticeship"){blurp3="-Massive Bonus Neophyte Experience#-Vastly Slower Neophyte Training";
