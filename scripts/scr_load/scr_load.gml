function scr_load(argument0, argument1) {
    ...
    if (argument0 = 1) or(argument0 = 0) {
        ...
        repeat(6) {
            j += 1;
            obj_controller.stc_bonus[j] = ini_read_real("Controller", "stc_bonus_" + string(j), 0);
        }
        j = -1;
        repeat(5) {
            j += 1;
            obj_ini.adv[j] = ini_read_string("Controller", "adv" + string(j), "");
        ...
        var i;
        i = -1;
        repeat(obj_controller.recent_happenings + 1) {
            i += 1;
            if (recent_type[i] != "") {
        ...
        var g;
        g = -1;
        repeat(obj_controller.recruits) {
            g += 1;
    ...
    if (argument0 = 2) or(argument0 = 0) {
        ...
        repeat(stars) {
            i += 1;
            var new_star;
            new_star = instance_create(0, 0, obj_star);
        ...
        repeat(21) {
            i += 1;
            obj_ini.company_title[i] = ini_read_string("Ini", "comp_title" + string(i), "");
        }
        var i;
        i = -1;
        repeat(121) {
            i += 1;
            obj_ini.slave_batch_num[i] = ini_read_real("Ini", "slave_num_" + string(i), 0);
            obj_ini.slave_batch_eta[i] = ini_read_real("Ini", "slave_eta_" + string(i), 0);
        }
        ...
        if (global.restart = 0) {
            ...
            for (coh = 0; coh <= 10; coh++) {
                for (mah = 0; mah <= 500; mah++) {
                    ...
                    arc = 0;
                    teh = "";
                    teh2 = ""; // Give daemon weapons their dialogue lines
                    for (arc = 1; arc < 6; arc++) {
    ...
    if (argument0 = 4) or(argument0 = 0) {
        ...
        repeat(num) {
            i += 1;
            fla = instance_create(0, 0, obj_en_fleet);
    ...
    if (argument0 = 5) or(argument0 = 0) {
        ...
        repeat(11) {
            i += 1;
            obj_controller.restart_title[i] = ini_read_string("Res", "tit" + string(i), "");
        }
        ...
        repeat(5) {
            ad += 1;
            obj_controller.restart_adv[ad] = ini_read_string("Res", "adv" + string(ad), "");
            obj_controller.restart_dis[ad] = ini_read_string("Res", "dis" + string(ad), "");
        }
