	            ...
	            if (stop=0){
	                ...
	                if (okay=1){
                     ...
                     // info about boarding stats
						...
						if (targ.marine_armour[targ.men]="MK5 Heresy") or (targ.marine_armour[targ.men]="MK6 Corvus") then targ.marine_ac[targ.men]=15;
	                    ...
	                    if (targ.marine_armour[targ.men]="MK7 Aquila") then targ.marine_ac[targ.men]=17;
