function scr_purge_world(argument0, argument1, argument2, argument3) {
	...
	if ((argument2=2) or (argument2=3)) and (argument0.p_traitors[argument1]=0) and (argument0.p_chaos[argument1]=0) and (obj_controller.turn>=obj_controller.chaos_turn){
	    if (planet_feature_bool(argument0.p_feature[argument1],P_features.Warlord10) == 1) and (obj_controller.known[eFACTION.Chaos]=0) and (obj_controller.faction_gender[10]=1) then with(obj_drop_select){
	    ...
	    if (planet_feature_bool(argument0.p_feature[argument1],P_features.Warlord10) == 1) and (obj_controller.known[eFACTION.Chaos]>=2) and (obj_controller.faction_gender[10]=1) then with(obj_drop_select){
	        alarm[6]=1; 
	    }
	}
