...
if (diplomacy == 10.1){
	...
	if (diplomacy==2){
	    ...
	    if (string_count("agree",diplo_keyphrase)==1){
	        ...
	        if (liscensing>0){
	            diplo_text="[[Trade Accepted.  License(s) Transmitted.]]##";
	            force_goodbye=1;
	            // TODO something else here; schedule the liscene and do not go to the next audience
	        }
	...
	if (diplomacy==4){
	    ...
	    if (diplo_keyphrase=="disagree"){
			if (trading_artifact==0) then diplo_text="[[Trade Refused]]##";
			if (trading_artifact==1) then diplo_text="";annoyed[diplomacy]+=2;
	...
	// ** Eldar **
	if (diplomacy=6){// TODO continue refactor
