function scr_dialogue(argument0) {
	...
	if (diplomacy=2){// Imperium
	    ...
	    if (argument0="open_trade") then diplo_text="Make your proposal, Chapter Master.";
	    if (argument0="artifact_thanks"){
	...
	if (diplomacy=5){// Ecclesiarchy
	    ...
	    if (argument0="open_trade") then diplo_text="Make me an offer, Space Marine, and I will pray for the guidance to respond.";
	    if (argument0="artifact"){
	        diplo_option[1]="Propose a trade for the Artifact.";diplo_option[2]="Leave it be; Exit.";
