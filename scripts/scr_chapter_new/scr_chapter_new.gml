function scr_chapter_new(argument0) {
	...
	repeat(3){i+=1;// First is for the correct slot, second is for default
	    ...
	    role[i,3]="Veteran";wep1[i,3]="Chainsword";wep2[i,3]="Bolter";armour[i,3]="Power Armour";
  ...
  if (argument0="Imperial Fists"){founding="N/A";points=150;
		...
		homeworld_exists=1;recruiting_exists=0;homeworld_rule=2;aspirant_trial="Survival of the Fittest";
