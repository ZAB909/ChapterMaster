	            ...
	            if (stop=0){
	                ...
	                if (okay>=1){
	                    ...
	                    if (obj_ini.role[cooh,va]=obj_ini.role[100,15]) or (obj_ini.role[cooh,va]=obj_ini.role[100,14]) or (string_count("Aspirant",obj_ini.role[cooh,va])>0){
	                        ...
	                        if (obj_ini.armour[cooh,va]="Terminator Armor")or (obj_ini.armour[cooh,va]="Tartaros Armor"){col=obj_controller.bat_terminator_column;}
	                        if (company=10) then col=obj_controller.bat_scout_column;
	                    }
	                    ...
	                    if (obj_ini.role[cooh,va]=obj_ini.role[100,5]) or (obj_ini.role[cooh,va]="Standard Bearer") or (obj_ini.role[cooh,va]=obj_ini.role[100,7]){
	                        ...
	                        if (company=1){
	                            ...
	                            if (obj_ini.armour[cooh,va]="Terminator Armor") then col=obj_controller.bat_terminator_column;
	                            if (obj_ini.armour[cooh,va]="Tartaros Armor") then col=obj_controller.bat_terminator_column;
	                        }
	                        if (company>=2) then col=obj_controller.bat_tactical_column;
	                        if (company=10) then col=obj_controller.bat_scout_column;
	                    ...
	                    if (targ.marine_armour[targ.men]="Scout Armor") then targ.marine_ac[targ.men]=8;
	                    if (targ.marine_armour[targ.men]="MK3 Iron Armor"){targ.marine_ac[targ.men]=20;targ.marine_ranged[targ.men]-=0.1;}
	                    ...
	                    if (targ.marine_armour[targ.men]="Power Armor") then targ.marine_ac[targ.men]=19;
	                    if (targ.marine_armour[targ.men]="Artificer Armor"){targ.marine_ac[targ.men]=35;targ.marine_attack[targ.men]+=0.1;}
	                    if (targ.marine_armour[targ.men]="Terminator Armor"){targ.marine_ac[targ.men]=40;targ.marine_ranged[targ.men]-=0.1;targ.marine_attack[targ.men]+=0.2;man_size = 2;}
	                    ...
	                    if (targ.marine_armour[targ.men]="Ork Armor") then targ.marine_ac[targ.men]=15;
