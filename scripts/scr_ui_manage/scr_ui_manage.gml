	        ...
	        if (cn.temp[101]!="") and (cn.temp[100]="1"){
	            ...
	            if( shader_is_compiled(sReplaceColor)){
	                ...
	                */
	                ...
	                if (temp[102]="Scout Armor"){if (slow>0) then slow=10;armour_sprite=spr_scout_colors;if (hood=-50) then hood=0;}
	                if (temp[102]="MK3 Iron Armor"){if (slow>0) then slow=13;if (brothers>-5) then brothers=3;armour_sprite=spr_iron2_colors;if (hood=-50) then hood=5;}
	                ...
	                if (temp[102]="MK7 Aquila") or (temp[102]="Power Armor"){if (brothers>-5) then brothers=0;if (slow>0) then slow=13;armour_sprite=spr_aquila_colors;if (hood=-50) then hood=1;}
	                ...
	                if (show_arm="Artificer Armor"){if (slow>0) then slow=13;if (brothers>-5) then brothers=1;armour_sprite=spr_artificer_colors;if (hood=-50) then hood=2;}
	                ...
	                if (show_arm="Terminator Armor"){armour_sprite=spr_terminator2_colors;if (brothers>-5) then brothers=5;if (hood=-50) then hood=9;if (skull=1) then skull=2;}
	                if (show_arm="Dreadnought") then armour_sprite=spr_dread_colors;
                
	                if (armour_sprite=spr_weapon_blank) and (temp[102]!=""){
	                    if (string_count("Power Armor",temp[102])>0){if (slow>0) then slow=13;if (brothers>-5) then brothers=0;armour_sprite=spr_aquila_colors;if (hood=-50) then hood=1;}
