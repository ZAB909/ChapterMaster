...
if (owner == eFACTION.TYRANIDS) {
    ...
    repeat (2) {
        ...
        if (obj_fleet.en_mutation[i] == "Armour") {
            armour_front += 1;
        }

        if (obj_fleet.en_mutation[i] == "Speed") {
            speed_bonus = speed_bonus * 1.1;
        }

        if (obj_fleet.en_mutation[i] == "Turn") {
            turn_bonus = 1.2;
        }

        if (obj_fleet.en_mutation[i] == "Turret") {
            turrets += 1;
        }
    }
}
