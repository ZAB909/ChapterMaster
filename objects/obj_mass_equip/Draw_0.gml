...
if (total_role_number>0){
    ...
    if (req_armor!=""){
        draw_set_color(c_gray);if (req_armor_num>have_armor_num) then draw_set_color(c_red);
        if (req_armor_num>have_armor_num) then draw_text_transformed(xx+154,yy+726,string_hash_to_newline("-Not enough "+string(req_armor)+" (Have "+string(have_armor_num)+", Need "+string(req_armor_num)+")"),0.6,0.6,0);
        if (req_armor_num<=have_armor_num) then draw_text_transformed(xx+154,yy+726,string_hash_to_newline("-"+string(req_armor)+" (Have "+string(have_armor_num)+", Need "+string(req_armor_num)+")"),0.6,0.6,0);
    }
    if (req_gear!=""){
