        ...
        if (role_number[co]>0){
            repeat(300){i+=1;
                if (obj_ini.role[co,i]=obj_ini.role[100,role]){
                    ...
                    if (yes=false){
                        if (obj_ini.armour[co,i]!=""){scr_add_item(obj_ini.armour[co,i],1);obj_ini.armour[co,i]="";}
                        if (obj_ini.armour[co,i]="") and (req_armour="Power Armour"){
                            ...
                            if (done!=""){scr_add_item(done,-1);obj_ini.armour[co,i]=done;}
                        }
...
if (refresh=true) and (obj_controller.settings>0){// Refreshing
    ...
    armour_equip="";wep1_equip="";wep2_equip="";mobi_equip="";gear_equip="";all_equip="";
    req_armour="";req_armour_num=0;have_armour_num=0;req_wep1="";req_wep1_num=0;have_wep1_num=0;
    ...
    repeat(11){co+=1;i=0;
        repeat(300){i+=1;
            ...
            if (obj_ini.role[co,i]=obj_ini.role[100,role]){
                ...
                hue2=0;
                if (obj_ini.armour[co,i]!=""){hue=0;hue2=0;
                    repeat(60){hue+=1;if (hue2=0){if (arm[hue]=obj_ini.armour[co,i]){hue2=-5;arm_n[hue]+=1;}}}
                    if (hue2=0){hue=0;repeat(30){if (hue2=0){hue+=1;if (arm[hue]=""){hue2=-5;arm[hue]=obj_ini.armour[co,i];arm_n[hue]=1;}}}}
                }
                hue2=0;
    ...
    i=0;repeat(60){i+=1;if (arm[i]!="") then armour_equip+=string(arm_n[i])+"x "+string(arm[i])+", ";}
